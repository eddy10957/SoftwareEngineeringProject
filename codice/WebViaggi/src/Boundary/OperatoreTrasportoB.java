...
public class OperatoreTrasportoB {
	private final BufferedReader consoleReader;
	private final PrintWriter consoleWriter;
	
	 public OperatoreTrasportoB(PrintWriter consoleWriter, BufferedReader consoleReader) {
		 this.consoleWriter=consoleWriter;
		 this.consoleReader=consoleReader;
    }

    private void inserisciServizioTrasporto() {
        // TODO implement here
    }
